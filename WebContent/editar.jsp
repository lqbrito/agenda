...
<body>
	...
	<form action="update" name="frmContato">
		<table>
			<tr>
				<td><input type="text" name="idcon" placeholder="Id" class="caixa3" readonly value="<% out.print(request.getAttribute("idcon")); %>"></td>
			</tr>
			<tr>
			...
			<tr>
				<td><input type="email" name="email" placeholder="Email" class="caixa1" value="<% out.print(request.getAttribute("email")); %>"></td>
			</tr>
		</table>
